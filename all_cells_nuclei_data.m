...
% 
% Description: Secondary antibody intensity qualification for just one
% sample cell.


%% Load Data

load('GFP_with_Nuclei_COM.mat')                                                     % Loads the Cell Object COM Data
Stain_image = imread('5kPa_rMSC_well1_w1DAPI Widefield_s2.TIF');                    % Reads in the TRITC channel image
...
for n = 2:max(dataTable.Cell)
    ...
    if contained == 1    
        ...
        % Start testing points in the cell
             ...
             if waterL_GFP(rand_point_y, rand_point_x) == n
                  ...
                  if ~(x1 == x2 && y1 == y2)
                      ...
                      while waterL_GFP(int16(new_point_y), int16(new_point_x)) == n             % While the new point is still contained in the cell
                          ...
                          % If new point is now at an edge
         ...
         %%
         save(['all_cell_',num2str(n),'_35kPa_DAPI.mat'],'normal_r','norm_intensity','comPtDist','phase');
    end
end