...
for n = 2:8
    ...
    filename = ['all_cell_',num2str(n),'_35kPA_protein.mat'];
    ...
    if contained == 2
        ...
        saveFileName = ['all_cell_',num2str(n),'_35kPA_Histogram.mat'];  % Change this file name!!!!!!!
        save(saveFileName,'mean_bins','std_bins','sem_bins');
    end
end
